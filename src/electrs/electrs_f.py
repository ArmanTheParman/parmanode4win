...
def docker_run_electrs(db_dir=None):
    ...
    command = ["powershell", "docker", "run", "-d", "--name", "electrs", "-p", "50005:50005", "--restart", "unless-stopped", "-p", "50006:50006", "-p", "9060:9060", "-v", f"{db_dir}:/electrs_db", "-v", f"{dot_electrs}:/home/parman/.electrs", "electrs"]
